...
<div class="h-screen flex flex-col justify-center items-center bg-gradient-to-r from-orange-400 via-orange-300 to-white text-black-600">
  <div class="text-center">
    ...
    <a href="/" class="bg-orange-500 text-white font-bold py-3 px-6 rounded-lg shadow-lg hover:bg-orange-600 transition ease-in-out duration-300">Go back to Home</a>
  </div>
</div>
