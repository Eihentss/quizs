...
<div class="h-screen flex justify-center items-center bg-gradient-to-r from-purple-500 via-pink-500 to-red-500">
    <div class="bg-gradient-to-br from-gray-900 to-gray-700 backdrop-blur-lg backdrop-opacity-70 shadow-lg rounded-lg p-8 w-96">
        <div class="text-center mb-8">
            <h1 class="text-4xl font-extrabold text-white mb-4">Register</h1>
            <p class="text-gray-300">Join the game and click your way to victory!</p>
        </div>
        ...
        <form class="space-y-6" method="post">
            ...
            <button type="submit" class="w-full bg-gradient-to-r from-pink-500 to-purple-500 text-white font-bold py-2 px-4 rounded-md hover:bg-gradient-to-r hover:from-pink-600 hover:to-purple-600 focus:outline-none focus:ring-4 focus:ring-pink-500 focus:ring-opacity-50 transition-transform transform hover:scale-105 ease-in-out duration-300">Register</button>
        </form>
        ...
        <div class="text-center mt-4">
            <a href="/user/login" class="text-pink-300 hover:underline">Already have an account? Log in!</a>
        </div>
    </div>
</div>